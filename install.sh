...
echo "── Pipeline files ───────────────────────────────────────────"
for dir in context specs prompts docs governance tools; do
...
echo "  2. Create .smiddy/specs/<yyyy-mm-dd>-<feature>/ based on your raw requirements (Phase 01)."
echo "  3. Run the phases in order. See .smiddy/docs/ for invocation patterns."
echo
